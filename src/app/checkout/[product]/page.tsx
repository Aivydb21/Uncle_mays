      ...
      <div className="container px-4 max-w-2xl mx-auto">
        ...
        <div className="rounded-2xl overflow-hidden shadow-soft bg-background">
          ...
          <div className="p-6 md:p-8">
            ...
            <div className="mb-6 p-4 rounded-xl border border-primary/20 bg-primary/5 text-center">
              ...
              <p className="text-sm font-semibold text-foreground">
                Join your neighbors who love Uncle May&apos;s
              </p>
              <p className="text-xs text-muted-foreground mt-1">
                97% say they want us in their neighborhood &bull; 89% refer friends &amp; family
              </p>
            </div>
