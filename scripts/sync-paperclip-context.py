...
What it does:
1. Reads ~/Desktop/um_website/CLAUDE.md (the source of truth).
...
CLAUDE_MD = os.path.expanduser("~/Desktop/um_website/CLAUDE.md")
...
> **THIS FILE IS KEPT IN SYNC WITH `~/Desktop/um_website/CLAUDE.md`** (the source of truth).
> Last synced: {date_str}. Do not edit this file directly. Edit `CLAUDE.md` and re-run
> `python ~/Desktop/um_website/scripts/sync-paperclip-context.py`.
>
